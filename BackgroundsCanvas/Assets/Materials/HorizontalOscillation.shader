Shader "Custom/HorizontalOscillation"
{
    Properties
    {
        ...
        SubShader{
            ...
            void surf(Input IN, inout SurfaceOutput o) {
                half4 c = tex2D(_MainTex, IN.uv_MainTex + float2(_DistortionScale / 3, 0) * sin((_Time * _DistortionSpeed / 1.3 + IN.uv_MainTex.y) * _DistortionFrequency / 2));
